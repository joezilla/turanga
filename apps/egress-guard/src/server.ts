...
const DEFAULT_CALLBACK_TOKEN = "dev-guard-callback";
const adminToken = process.env.GUARD_ADMIN_TOKEN ?? DEFAULT_ADMIN_TOKEN;
const callbackToken = process.env.GUARD_CALLBACK_TOKEN ?? DEFAULT_CALLBACK_TOKEN;
...
if (process.env.NODE_ENV === "production" && callbackToken === DEFAULT_CALLBACK_TOKEN) {
